...
# **Answer:** 
# 
# I tried different batch_sizes and changed the sequence_length parameters. I took care to choose parameters to make the loss decreasing, not increasing. I set the sequence_length to 10 (number of words), it looked optimal and batch_size to 128.   
# 
# Again, I used different hidden dimension numbers (starting from 150 to 350) with increasing number of epochs (starting from 5 upwards to 10), from 2-5 RNN layers. I noticed that hidden dimension is optimal at the level of 260 with 10 epoch showed lower loss. Also having 2 RNN layers with those parameters showed lower loss. 
# 
# 
